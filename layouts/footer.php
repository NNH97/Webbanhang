                            ...
                            <div class="col-md-3" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p><i class="fa fa-home" style="font-size: 16px;padding-right: 5px;"></i> 02 Phù Đổng- ngã tư Phù Đổng - Nguyễn Trãi </p>
                                        <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i> 0914470465</p>
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    else
                    {
                        ...
                        alert("Số lượng hàng bạn chọn đã nhiều hơn số lượng hàng cửa hàng đang có !");
                        location.href='giohang.php';
                    }
                }
